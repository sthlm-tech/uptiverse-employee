## Uptiverse Employee Micro Service



##### Setting up Node, Heroku and Mongo ############

Node.js / Express / MongoDB based Micro Service.
...
The --save flag will automatically include the package in package.json as a dependency.## Node.js / Express.js / MongoDb (+Mongoose) Boilerplate
